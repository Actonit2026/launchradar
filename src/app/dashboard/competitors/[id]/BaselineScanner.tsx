    ...
    return (
      <div className="border border-red-500/30 bg-red-500/5 rounded-xl p-8 text-center mb-8">
        ...
        <button onClick={runScan}
          className="text-sm bg-radar-surface border border-radar-border text-radar-text px-5 py-2 rounded-lg hover:border-radar-accent/40 hover:text-radar-accent transition-colors">
          Retry scan
        </button>
      </div>
    )
  ...
  return (
    <div className="border border-radar-accent/20 bg-radar-surface rounded-xl p-10 text-center mb-8">
      <div className="relative w-16 h-16 mx-auto mb-6">
        ...
        <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-radar-accent animate-spin"
      ...
      <p className="text-radar-text-muted text-xs mt-4">
        Scanning homepage, pricing, features and changelog — takes 15–30s
      </p>
    </div>
  )
}
